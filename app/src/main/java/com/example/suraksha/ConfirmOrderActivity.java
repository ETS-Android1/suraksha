...
public class ConfirmOrderActivity extends AppCompatActivity {
    ...
    EditText otpEditText; TextView totalTextView; Button confirmButton;
    ...
    public void confirmOTP()
    {
        ...
        {
            PhoneAuthCredential phoneAuth = PhoneAuthProvider.getCredential(code, userCode);
            FirebaseAuth.getInstance().signInWithCredential(phoneAuth).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    {
                        Toast.makeText(ConfirmOrderActivity.this, "Enter correct OTP", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
